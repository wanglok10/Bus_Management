...
public class ViewStaffController {
    ...
    public String viewStaffController(Model model, @RequestParam Map<String, String> params) {
        model.addAttribute("staffs", this.staffService.getStaffs(params));

        int count = this.staffService.countStaff();
