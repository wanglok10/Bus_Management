<%-- 
    Document   : footer
    Created on : Jul 31, 2023, 5:16:14 PM
    Author     : Admin
--%>

<%@page contentType="text/html" pageEncoding="UTF-8"%>
<div id="content" th:fragment="content">
    <!-- Thêm phần nội dung của trang vào đây -->
</div>

<div class="bg-primary">
        <footer class="footer container" >
            <div class="d-flex flex-row  text-white rounded" >
                <div class="col-6 mt-2 p-5 ">
                    <h1>Nguyễn Ngọc Luân &copy; 2023</h1>
                    <p class="text-center">Khoa CNTT, Đại học Mở Tp.HCM</p>
                </div>
                <div class="col-3 mt-2 p-5">
